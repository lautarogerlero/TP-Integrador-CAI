...
namespace TPIntegrador
{
    internal class Program
    {
        ...
        public static UsuarioModel BajaUsuario(List<UsuarioModel> Usuarios)
        {
            bool usuarioEncontrado = false;
            UsuarioModel usuario;
            do
            {
                string nombre = ConsolaUtils.PedirString("Ingrese el nombre del usuario a dar de baja");
                string apellido = ConsolaUtils.PedirString("Ingrese el apellido del usuario a dar de baja");
                // Busca que en usuarios haya un usuario con ese nombre y ese apellido
                usuario = Usuarios.Find(u => u.Nombre == nombre && u.Apellido == apellido);
                if (usuario == null)
                {
